...
public class ChatRoom {
	...
	public static void openChatRoom(String iD, String chat_room_name) {
		...
		while(true) {
			System.out.println("Chat Room: "+chat_room_name);
			System.out.println();
			...
			case 2:
				...
				String final_record = iD + ": " + user_record;

				ProducerRecord<String, String> record = new ProducerRecord<>(chat_room_name, null, final_record);
